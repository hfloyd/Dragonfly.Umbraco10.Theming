...
namespace Dragonfly.UmbracoTheming.Composers
{
    public class DragonflyThemingApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Dragonfly Umbraco 10 Theming Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<DragonflyUmbracoThemingOperationSecurityFilter>();
            });
        }

        public class DragonflyUmbracoThemingOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
